...
class avionicsUnit:
    ...
    def controlAttitude(self, target_vector, ref_frame, vessel=vessel, smoothness=50):
...
while True:    
    ...
    avionics.controlAttitude([40.0,270.0], ref_surf, smoothness=2000)
    #print(avionics.distance_yaw)


avionics.updateNumbers([40,270.0], ref_surf)
